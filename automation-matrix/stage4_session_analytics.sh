...
# Pull active keys dynamically from the workspace ecosystem configurations
...
case $TELEMETRY_ACTION in
    1)
        echo "Fetching session histories from agents.assemblyai.com cloud..."
        curl -s "https://agents.assemblyai.com/v1/sessions?limit=5" \
